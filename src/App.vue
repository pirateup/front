...
body {
  ...
  /* container class is for nesting (boxing around) app, not for components */
.container {
  position: absolute;
  left: 0;
  width: 100%;
  ...
  /* For boxing componets -> nest them in column or columns class.
  Column and columns are filling out full space of a conteiner
  while adding written number sets an column in size as described below
  |one|
  |two   |
  |three    |
  |four        |
  ...
  |ten                           |
  |eleven                           |
  |twelve or column or columns         |

  |container filled out fully          |
   */
.column,
.columns {
  width: 100%;
