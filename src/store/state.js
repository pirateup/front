export default
{
    ...
    // zoom will determinate how far from client we are looking
    // for shop or how far is shop from the client
    // for example client is looking around 1 km of his coords
    // so zoom needs to be calculated to show client and shop
    // both on the map, or if if user is searching in
